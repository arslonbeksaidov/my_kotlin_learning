...
fun main() {
    val list = listOf<String>("camel", "lion", "deer", "goose", "bat", "rabbit")
    val scanner = Scanner(System.`in`)
    var stopper = true
    do {
        print("Please enter the number of the habitat you would like to view: >")
        if (scanner.hasNextInt()) {
            val numberAnimal = scanner.nextInt()
            when (numberAnimal) {
                0 -> print(camel.trimIndent())
                1 -> println(lion.trimIndent())
                2 -> println(deer.trimIndent())
                3 -> println(goose.trimIndent())
                4 -> println(bat.trimIndent())
                5 -> println(rabbit.trimIndent())
            }
        }else if (scanner.hasNext() && scanner.next()=="exit"){
